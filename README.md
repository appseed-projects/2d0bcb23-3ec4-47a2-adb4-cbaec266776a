...
- Timestamp: `2022-06-04 12:34`
- Build ID: `2d0bcb23-3ec4-47a2-adb4-cbaec266776a`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/2d0bcb23-3ec4-47a2-adb4-cbaec266776a.git
$ cd 2d0bcb23-3ec4-47a2-adb4-cbaec266776a
```
